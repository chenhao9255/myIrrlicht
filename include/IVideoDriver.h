...
namespace video
{
	...
	{
		//! View transformation, view矩阵，物体的l,r,s
		ETS_VIEW = 0,
		//! World transformation,  model 矩阵，摄像机的l,r,s
		ETS_WORLD,
		//! Projection transformation， projection(投影)矩阵，投影形状，矩形，扇形
		ETS_PROJECTION,
		//! Texture transformation，纹理矩阵，l,r,s
		ETS_TEXTURE_0,
