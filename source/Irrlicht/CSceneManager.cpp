...
void CSceneManager::drawAll()
{
	...
	*/
	...
	//注册node，将需要渲染的node push到渲染队列中。ISceneNode::OnRegisterSceneNode()提供一个基础的方法，以遍历所有的子节点
	//将所有节点注册到CsceneManager的各个list中，例如core::array<ISceneNode*> LightList
	OnRegisterSceneNode();
	...
	// render default objects
	{
		...
		//video::SOverrideMaterial  s = Driver->getOverrideMaterial();
		Driver->getOverrideMaterial().Enabled = ((Driver->getOverrideMaterial().EnablePasses & CurrentRendertime) != 0);
