...
namespace scene
{
	...
	public:
		...
		//! Render
		//计算camera的view和projection矩阵，并且设置到driver中
		virtual void render();
	...
	protected:
		...
		core::vector3df Target;  //摄像机的朝向
		core::vector3df UpVector;//摄像机的轴，摄像机必须和轴平行

		f32 Fovy;	// Field of view, in radians. 视角，弧度制
		f32 Aspect;	// Aspect ratio. 屏幕长宽比
		f32 ZNear;	// value of the near view-plane. 
		f32 ZFar;	// Z-value of the far view-plane.

		SViewFrustum ViewArea;  //视锥体，可视区域
		//摄像机的影响因子，可以理解为一个相对矩阵V'，其与V相乘，调节摄像机的最终位置
